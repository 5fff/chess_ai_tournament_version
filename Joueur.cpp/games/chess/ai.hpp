...
#include "./AI/persistent_classes.h"
// #############
...
public:
    ...
    //below is a historian who lives forever, he writes down all the history moves,
    // and he will be informed with latest fen string and san string, he will figure out
    // the less ambiguis moves. at the same time he keeps a three_fold_tracker and will
    // update it. He will bestow the three_fold_tracker to every Minimax that visits him.
    persistent_stfr_tracker eternal_historian;//just a easy to memorize name lol
    persistent_containier enderchest;
